...
public class ConnectFourGame extends JPanel {
    ...
    public ConnectFourGame() {
        ...
        try {
            backgroundImage = ImageIO.read(ConnectFourGame.class.getResource("/images/background.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void showCustomNotification(String message, String title, String imagePath) {
        ...
        try {
            dialogBackgroundImage = ImageIO.read(ConnectFourGame.class.getResource(imagePath));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                ConnectFourGame gamePanel = new ConnectFourGame();
